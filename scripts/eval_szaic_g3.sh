...
VLLM_EVAL_MODEL_PATH="/aistor/sjtu/hpc_stor01/home/wangzijian/workspace/NeuSym-RAG/.cache/Qwen2.5-7B-OurInstruct"
VLLM_EVAL_SERVED_MODEL_NAME="qwen2.5-7b-ourinstruct"
VLLM_SUP_MODEL_PATH="/aistor/sjtu/hpc_stor01/home/wangzijian/workspace/NeuSym-RAG/.cache/Qwen2.5-7B-OurInstruct"
VLLM_SUP_SERVED_MODEL_NAME="qwen2.5-7b-ourinstruct"
...
VLLM_EVAL_LOG_FILE="./log/eval_vllm_server_3.log"
VLLM_SUP_LOG_FILE="./log/sup_vllm_server_3.log"
...
start_evaling() {
    ...
    python scripts/hybrid_neural_symbolic_rag_g3.py --dataset airqa --test_data test_data_553.jsonl --database ai_research --agent_method neusym_rag --llm qwen2.5-7b-ourinstruct 
    TRAINING_EXIT_CODE=$?
}
