...
VLLM_EVAL_MODEL_PATH="/aistor/sjtu/hpc_stor01/home/wangzijian/workspace/NeuSym-RAG/.cache/Qwen2.5-3B-OurInstruct"
VLLM_EVAL_SERVED_MODEL_NAME="qwen2.5-3b-ourinstruct"
...
VLLM_EVAL_LOG_FILE="./log/eval_vllm_server_2.log"
VLLM_SUP_LOG_FILE="./log/sup_vllm_server_2.log"
...
start_evaling() {
    ...
    python scripts/hybrid_neural_symbolic_rag_g2.py --dataset airqa --test_data test_data_553.jsonl --database ai_research --agent_method neusym_rag --llm qwen2.5-3b-ourinstruct 
    TRAINING_EXIT_CODE=$?
}
